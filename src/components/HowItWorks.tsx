...
export default function HowItWorks() {
  return (
    <section className="py-24 border-t border-faint relative">
      <div className="text-[0.6rem] uppercase tracking-widest text-muted mb-6">III. How It Works</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        {steps.map((s) => (
          <div key={s.n} className="relative">
            <div className="text-[0.55rem] uppercase tracking-widest text-muted mb-4">Step {s.n}</div>
            <h3 className="font-serif text-2xl italic font-light text-core mb-6">{s.title}</h3>
