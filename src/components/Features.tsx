...
export default function Features() {
  return (
    <section className="py-24 border-t border-faint relative">
      ...
      <div className="text-[0.6rem] tracking-widest text-muted mb-6">IV. Capabilities</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
        {features.map((f) => (
          <div key={f.n} className="group relative">
            <div className="text-[0.55rem] tracking-widest text-muted mb-4 flex items-center gap-3">
            ...
            <h3 className="font-display text-2xl font-semibold text-core mb-4">{f.title}</h3>
            <p className="text-[0.7rem] leading-relaxed tracking-widest text-main opacity-80">
              {f.body}
            </p>
          </div>
        ))}
