  ...
  return (
    <section className="py-32 border-t border-faint relative">
      ...
      <div className="text-center max-w-3xl mx-auto mb-32 relative z-10">
        <div className="text-[0.6rem] uppercase tracking-widest text-muted mb-6">VIII. Initialize</div>
        <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl italic font-light text-core leading-none mb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-faint pt-12">
        {cols.map((c) => (
          <div key={c.title}>
            <div className="text-[0.55rem] uppercase tracking-widest text-muted mb-4">{c.title}</div>
            <ul className="flex flex-col gap-2 text-[0.65rem] uppercase tracking-widest text-main">
              {c.items.map((i) => (
      ...
      <div className="mt-16 pt-8 border-t border-faint flex justify-between items-center">
        <p className="text-[0.65rem] uppercase tracking-widest text-main font-bold italic font-serif text-base">
          Programmable stablecoin payments. Built for what's next.
        </p>
        <p className="text-[0.55rem] uppercase tracking-widest text-muted">
          © 2026 Atara Labs
        </p>
      </div>
    </section>
